...
const userShema = new mongoose.Schema({
  name: {
    ...
    validate:{
      ...
      message: 'Name should contain at least four character. No Numerical value and special charater except space'
    },
    minlength: 4
  ...
  password: {
    ...
    validate:{
      ...
      message: 'Password should contain at least one upper, lower, Numeric and special character'
    }
  },
  passwordconfirmed: {
    type: String,
    required: [true, 'A user should have a passwordconfirm'],
    minlength: 8,
    validate: {
      validator: function(el) {
